...
function houston_filename_lowercase($filename) {
...
add_filter('sanitize_file_name', 'houston_filename_lowercase', 10);


//---------------------------------------------------------------------------------
//	Define image sizes
//---------------------------------------------------------------------------------
add_image_size( 'houston-default', '1200', '9999', false );

//---------------------------------------------------------------------------------
//	Simple IMG-wrapper
//---------------------------------------------------------------------------------
function houston_image($src = false, $args, $size = "houston-default") {
	...
	$atts = array_merge($defaults,$args);	

	if(is_array($src)) {
		$src = $src['sizes'][$size];
	}
	return get_bloginfo("template_url")."/lib/timthumb/timthumb.php?src=".$src."&w=".$atts['w']."&h=".$atts['h']."&zq=".$atts['zc']."&f=".$atts['f'];
}
