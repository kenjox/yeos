(function(){var button=document.getElementById('site-navigation').getElementsByTagName('h3')[0],menu=document.getElementById('site-navigation').getElementsByTagName('ul')[0];if(undefined===button)
